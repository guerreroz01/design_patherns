...
"""
To create an iterator in Python, there are two classes from the builtin
...
class AlphabeticalOrderIterator(Iterator):
    """
    Concrete Iterator implement various traversal algorithms. These classes
    ...
    it is supposed to work with a particular kind of collections.
    """
    _possition: Optional[int] = None
    ...
    def __next__(self):
        ...
        reaching the and in subsequent calls, it must raise StopIteration.
        """
        try:
